...
public class InsertCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertCategoryServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = dao.getNumberCategory()+ 1;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Category c = new Category(Integer.parseInt(CatID), CatName);
        PokemonDAO dao = new PokemonDAO();
